...
For more information, see the [GitHub Actions workflow run](https://github.com/empirefx/idler/actions/runs/21785926512)
...
```text
Formatted 141 files in 316ms. Fixed 1 file.
...
Checked 145 files in 1435ms. No fixes applied.
Found 71 errors.
Found 121 warnings.
...
Scanned 4 files, found 122 errors in 2 files (42 ms)
```
