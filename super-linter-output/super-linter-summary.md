...
For more information, see the [GitHub Actions workflow run](https://github.com/empirefx/idler/actions/runs/21786006800)
...
```text
Formatted 141 files in 280ms. Fixed 1 file.
...
Checked 145 files in 1217ms. No fixes applied.
Found 71 errors.
Found 121 warnings.
