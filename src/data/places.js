export const placesData = {
  village_center: {
    ...
    name: "Village Center",
    description:
      "The heart of your small settlement. A humble gathering place where villagers meet.",
    type: "settlement",
    hasInventory: true,
  ...
  forest_edge: {
    ...
    name: "Forest Edge",
    description:
      "The boundary between civilization and wilderness. Ancient trees loom ahead.",
    type: "wilderness",
    ...
    spawn: {
      ...
      waveSize: [1, 1],
      respawnDelay: 5,
      drops: [{ itemId: "apple", dropRate: 0.1 }],
    },
  },
  deep_woods: {
    id: "deep_woods",
    name: "Deep Woods",
    description:
      "Dense forest where valuable resources can be found, but dangers lurk in the shadows.",
    type: "wilderness",
  ...
  hunter_camp: {
    ...
    name: "Hunter's Camp",
    description:
      "A rustic outpost where hunters gather and prepare for their expeditions.",
    type: "outpost",
  ...
  ancient_ruins: {
    ...
    name: "Ancient Ruins",
    description:
      "The remains of an ancient civilization, filled with mysterious artifacts and valuable resources.",
    type: "ruins",
