    ...
    <section className="control-section">
      ...
      <div className="control-bottom">
        <div className="keys-bindings">
          <span><KeyBind value="c" info="Display character stats"/> character</span>
          <span><KeyBind value="w" info="Open workers tab" /> workers</span>
        </div>
        <div className="resources">
          <span className="resource-item">{`${workerCount}/${maxWorkers}`} <b>workers</b></span>
          <span className="resource-item">{gold} <b>gold</b></span>
        </div>
      </div>
    </section>
  );
