import { INVENTORY_ERRORS, INVENTORY_TYPES, EQUIPMENT_SLOTS } from './inventoryTypes.js';
import { calculateWeight, countSlots, canItemsStack } from './inventoryUtils.js';

// Validation functions for inventory operations

export const validateSlotLimit = (inventory, additionalItemCount = 0) => {
  if (!inventory) return { isValid: false, error: INVENTORY_ERRORS.ITEM_NOT_FOUND };
...
export const validateItemMove = (fromInventory, toInventory, itemId, quantity) => {
