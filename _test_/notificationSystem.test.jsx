...
import { addNotification, NOTIFICATION_TYPES } from '../../src/store/slices/notificationSlice';
...
describe('Notification System', () => {
  ...
  test('should render single notification', () => {
    ...
    // Add a notification
    store.dispatch(addNotification('Test notification', NOTIFICATION_TYPES.INFO));
  ...
  test('should render warning notification', () => {
    ...
    store.dispatch(addNotification('Cannot carry more weight - inventory overweight!', NOTIFICATION_TYPES.WARNING));
    ...
    expect(screen.getByText('Cannot carry more weight - inventory overweight!')).toBeInTheDocument();
  });
  ...
  test('should render error notification', () => {
    ...
    store.dispatch(addNotification('Inventory is full - no more slots available!', NOTIFICATION_TYPES.WARNING));
    ...
    expect(screen.getByText('Inventory is full - no more slots available!')).toBeInTheDocument();
  });
});