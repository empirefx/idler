...
import { moveItemBetweenInventories, removeItemFromInventory } from '../src/store/slices/inventoryThunks.js';
...
describe('inventoryThunks', () => {
  ...
  describe('moveItemBetweenInventories', () => {
    it('should move item from player inventory to place inventory', () => {
      ...
      const playerState = {
        playerInventory: {
          player: {
            ...
            maxSlots: 20,
            maxWeight: 100,
            items: [{ id: 'apple1', name: 'apple', type: 'consumable', quantity: 5, weight: 0.5 }],
            equipment: { head: null, body: null, pants: null, 'main-weapon': null, 'second-weapon': null }
          }
        },
        placeInventory: {
          village_center: {
      ...
      const result = testStore.dispatch(moveItemBetweenInventories(
        'player',
        'village_center',
        'apple1',
        2
      ...
      const playerApples = state.playerInventory.player.items.find(item => item.id === 'apple1');
      expect(playerApples.quantity).toBe(3);
      
      // Village center should have 2 apples
      const villageApples = state.placeInventory.village_center.items.find(item => item.name === 'apple');
    ...
    it('should move item from place inventory to player inventory', () => {
      ...
      const placeState = {
        ...
        placeInventory: {
          village_center: {
            ...
            type: 'place',
            maxSlots: 30,
            items: [{ id: 'sword1', name: 'iron sword', type: 'equipment', piece: 'main-weapon', quantity: 1, weight: 5 }]
          }
        }
      };
      ...
      const playerSword = state.playerInventory.player.items.find(item => item.id === 'sword1');
    ...
    it('should handle partial stack moves correctly', () => {
      ...
      const partialState = {
        playerInventory: {
          player: {
            ...
            maxSlots: 20,
            maxWeight: 100,
            items: [{ id: 'berries1', name: 'berries', type: 'consumable', quantity: 10, weight: 0.1 }],
            equipment: { head: null, body: null, pants: null, 'main-weapon': null, 'second-weapon': null }
          }
        },
        placeInventory: {
      ...
      const playerBerries = state.playerInventory.player.items.find(item => item.id === 'berries1');
      expect(playerBerries.quantity).toBe(7);
      
      // Village center should have 3 berries
      const villageBerries = state.placeInventory.village_center.items.find(item => item.name === 'berries');
    ...
    it('should return false when source inventory does not exist', () => {
      const result = store.dispatch(moveItemBetweenInventories(
        'nonexistent',
        'village_center',
        'item1',
        1
      ...
      const fullTargetState = {
        playerInventory: {
          player: {
            ...
            maxSlots: 20,
            maxWeight: 100,
            items: [{ id: 'item1', name: 'test item', type: 'material', quantity: 1, weight: 1 }],
            equipment: { head: null, body: null, pants: null, 'main-weapon': null, 'second-weapon': null }
          }
        },
        placeInventory: {
          village_center: {
            ...
            items: [{ id: 'filler', name: 'filler', type: 'material', quantity: 1, weight: 1 }]
          }
        }
      };
      ...
      const overweightState = {
        ...
        placeInventory: {
          village_center: {
            ...
            type: 'place',
            maxSlots: 30,
            items: [{ id: 'heavy', name: 'heavy item', type: 'material', quantity: 1, weight: 100 }]
          }
        }
      };
  ...
  describe('removeItemFromInventory', () => {
    it('should remove item from player inventory', () => {
      ...
      const result = testStore.dispatch(removeItemFromInventory(
        'player',
        'apple1',
        2
      ));
      ...
      const placeState = {
        ...
        placeInventory: {
          village_center: {
            ...
            type: 'place',
            maxSlots: 30,
            items: [{ id: 'berry1', name: 'berries', type: 'consumable', quantity: 10, weight: 0.1 }]
          }
        }
      };
      ...
      const state = {
        playerInventory: {
          player: {
            ...
            maxSlots: 20,
            maxWeight: 100,
            items: [{ id: 'single1', name: 'single item', type: 'material', quantity: 1, weight: 1 }],
            equipment: { head: null, body: null, pants: null, 'main-weapon': null, 'second-weapon': null }
          }
        },
        placeInventory: {}
    ...
    it('should return false when inventory does not exist', () => {
      const result = store.dispatch(removeItemFromInventory(
        'nonexistent',
        'item1',
        1
      ));
      ...
      const placeState = {
        ...
        placeInventory: {
          some_place_id: {
            ...
            type: 'place',
            maxSlots: 30,
            items: [{ id: 'test', name: 'test', type: 'material', quantity: 1, weight: 1 }]
          }
        }
      };
