...
import enemiesReducer, { addEnemy, removeEnemy, removeEnemiesByPlace, damageEnemy, selectAllEnemies, selectEnemiesForCurrentPlace, initializeCountdownsForPlace } from '../src/store/slices/enemiesSlice';
...
describe('enemiesSlice reducer and selectors', () => {
  ...
  describe('Synchronized Countdown Initialization', () => {
    it('should initialize countdowns for all enemies at a specific place', () => {
      let s = enemiesReducer(state, addEnemy({ 
        placeId: 'test_place', 
        enemy: { 
          id: 'enemy1', 
          health: 50,
